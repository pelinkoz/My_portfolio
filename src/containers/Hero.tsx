  ...
  return (
    <div id="home" className="min-h-screen flex flex-col items-center justify-center text-center bg-gradient-to-br from-[#1e1b4b] via-[#581c87] via-[#6b21a8] to-[#1e1b4b] text-white">
        <div className="text-center">
            <h1 className="text-5xl md:text-6xl text-white font-bold">Hi, My name is <span className='bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent'>Pelin Koz</span> </h1>
            <p className="text-xl mt-4 text-white">Software Developer passionate about building smart applications powered by Artificial Intelligence.</p>
